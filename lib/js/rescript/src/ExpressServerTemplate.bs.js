...
function ExpressServerTemplate(Logger, Controller, RequestResponseManager) {
  var initExpressApp = function (app) {
    return Belt_Result.flatMap(Belt_Result.flatMap(Curry._1(Logger.initExpressApp, app), (function (param) {
                      return Curry._1(RequestResponseManager.initExpressApp, app);
                    })), (function (param) {
    ...
    var result = Belt_Array.reduce(Belt_Array.map(Curry._1(Controller.getAllActions, undefined), (function (a) {
                ...
                app.get(...funParams);
                    ...
                    if (obj.RE_EXN_ID === Js_exn.$$Error) {
                      ...
                      return {
                              TAG: /* Error */1,
                              _0: Curry._1(Logger.getUnknownError, undefined)
                            };
                    }
                  }
                  ...
                  try {
                    var multiMiddlewares = isMultipart ? Curry._1(RequestResponseManager.buildMultipartDataMiddleware, isMultipart._0) : [];
                    var res$1 = (function(path, middlewares, handlerFunc, multiMiddlewares) {
                ...
                app.post(...funParams);
                    ...
                    res$1(handlerPath, handlerMiddlewares, handlerFunc, multiMiddlewares);
                    return {
                            TAG: /* Ok */0,
                            _0: undefined
                          };
                  ...
                  try {
                    var multiMiddlewares$1 = isMultipart$1 ? Curry._1(RequestResponseManager.buildMultipartDataMiddleware, isMultipart$1._0) : [];
                    var res$2 = (function(path, middlewares, handlerFunc, multiMiddlewares, route) {
                const middlewares2 = multiMiddlewares.concat(middlewares)
                const funParams = [path]
                    .concat(middlewares2)
                    .concat([handlerFunc]);
                app[route](...funParams);
                    ...
                    res$2(handlerPath, handlerMiddlewares, handlerFunc, multiMiddlewares$1, routeType);
                    return {
                            TAG: /* Ok */0,
                            _0: undefined
                          };
  ...
  var run = function (port) {
    return Belt_Result.flatMap(Belt_Result.flatMap(initExpressApp(appUnit), registerActions), (function (param) {
                  try {
